    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            Parent1Relationship = table.Column<string>(nullable: true),
            Parent1AddressLine1 = table.Column<string>(nullable: true),
            Parent1AddressLine2 = table.Column<string>(nullable: true),
            Parent1ZipCode = table.Column<int>(nullable: false)
          },
          constraints: table =>
          {
